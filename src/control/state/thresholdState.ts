import type { DecisionFeedbackRecord } from "../../modules/capability/feedback/decisionFeedbackRecorder.ts"
...
export function adaptThresholdState(input: ThresholdAdapterInput): ThresholdAdapterOutput {

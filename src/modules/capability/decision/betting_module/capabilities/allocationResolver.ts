import type { BettingDecision, ResourceAllocation } from "../types/betting.ts"
import type { CapabilityDefinition, ProtocolRequest, ProtocolResponse } from "../types/protocol.ts"
import { bettingDecisionAllocations } from "../../../../../control/mapping/bettingDecisionMapping.ts"
...
export function invokeAllocationResolver(
  ...
  const allocation = bettingDecisionAllocations[request.payload.decision]

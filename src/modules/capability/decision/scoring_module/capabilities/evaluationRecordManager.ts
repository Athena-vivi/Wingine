...
import { scoringProfiles } from "../data/scoringProfiles.ts"
...
import type { DimensionScoreEntry, EvaluationRecord, EvaluatorRole, RoleInput, ScoringDimension, ScoringObject } from "../types/scoring.ts"

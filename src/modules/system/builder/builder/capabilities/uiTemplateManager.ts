import type { BuilderCapabilityDefinition, UITemplate } from "../types/builder.ts"
import { resolveTemplateSelection } from "../../../../../control/policy/builderPolicy.ts"
...
export function resolveUITemplate({ templateId, templates }: ResolveUITemplateInput): { template: UITemplate } {
  const template = resolveTemplateSelection({
    templateId,
    templates,

import { skillModulesById } from "../data/skills.ts"
import type { BuilderCapabilityDefinition, BuilderCapabilityDetail, Capability, WorkflowStep } from "../types/builder.ts"

...
import type { ModuleStatus, OutputStatus, WorkflowStatus } from "../../../../capability/shared/index.ts"
import type { BuilderBetFeedbackIntake } from "../adapters/betFeedbackImportAdapter.ts"
import type { BuilderFeedbackIntake } from "../adapters/scoreFeedbackImportAdapter.ts"
...
export async function applyScoringFeedbackToBuilderState(feedback: BuilderFeedbackIntake) {
  ...
  state.feedback_log = [
    ...
    } satisfies BuilderFeedbackEntry,
    ...state.feedback_log
  ].slice(0, 100)
